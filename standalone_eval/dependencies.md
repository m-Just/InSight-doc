# Standalone Evaluation Dependencies

The standalone evaluator is intended to run against an already-available model endpoint or a local model served through the included Ray/vLLM helper.
