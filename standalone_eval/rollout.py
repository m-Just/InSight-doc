...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Standalone rollout-only InSight eval. Generates and exports conversations without scoring.",
    )
    ...
    parser.add_argument(
        "--agent-config",
        default="standalone_eval/agent_configs/insight_qwen_agent_core_zoom_factor2_area3500_rescale025.yaml",
    )
    parser.add_argument(
