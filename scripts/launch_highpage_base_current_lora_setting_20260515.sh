...
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/highpage_base_current_lora_setting_20260515}"
...
run_eval_one() {
  ...
  local scale_value="$2"
  local agent_cfg="$3"
  local model_label="base_before_sft_current_lora_setting"
...
log "all base highpage eval jobs finished"
