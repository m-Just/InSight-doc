...
WORK_DIR="${WORK_DIR:-/scratch/ywxzml3j/likaican/temp/insight_qwen_agent_full_sft_newdata}"
EXP_NAME="${EXP_NAME:-insight_qwen_agent_full_sft_newdata}"
...
$(TRAIN_FILE_1="${TRAIN_FILE_1}" TRAIN_FILE_2="${TRAIN_FILE_2}" VAL_FILE="${VAL_FILE}" python - <<'PY'
import os
...
CMD=(
  ...
  "data.train_files=['${TRAIN_FILE_1}','${TRAIN_FILE_2}']"
