...
DEFAULT_OUTPUT_ROOT = REPO_ROOT / "artifacts" / "answerable_vr2_inputs" / "all_easy_vr2_input_20260518"
...
LANES: list[Lane] = [
    Lane(
        ...
        export_dir=Path(
            ...
            "insight_qwen_agent_zoom_factor2_area1800_rescale035_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/O3_data_0424-dpi200_aug_noaug_maxp40/train_part3d/"
    ...
    Lane(
        ...
        export_dir=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_area2500_rescale05_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/O3_data_0424-dpi200_aug_noaug_maxp40/train_part3a/"
            "exported_conversations"
        ),
        wrong_ids_path=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
    ...
    Lane(
        ...
        export_dir=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_area1800_rescale035_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/O3_data_0424-dpi200_aug_noaug_maxp40/train_part3b/"
            "exported_conversations"
        ),
        wrong_ids_path=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
    ...
    Lane(
        ...
        export_dir=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_area2500_rescale05_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/O3_data_0424-dpi200_aug_noaug_maxp40/train_part3c/"
            "exported_conversations"
        ),
        wrong_ids_path=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
    ...
    Lane(
        ...
        export_dir=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/veqa_batch_0350_r2_train_mveqa_batch_0352_r2_train-dpi200_aug_noaug_maxp40/"
            "train_part1/exported_conversations"
        ),
        wrong_ids_path=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/veqa_batch_0350_r2_train_mveqa_batch_0352_r2_train-dpi200_aug_noaug_maxp40/"
            "train_part1/converted_sft/wrong_question_ids.txt"
        ),
    ...
    Lane(
        ...
        export_dir=Path(
            ...
            "insight_qwen_agent_zoom_factor2_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/veqa_batch_0350_r2_train_mveqa_batch_0352_r2_train-dpi200_aug_noaug_maxp40/"
            "train_part2/exported_conversations"
        ),
        wrong_ids_path=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_default_sys_0426_resumable/"
            "qwen3-vl-32b-instruct/veqa_batch_0350_r2_train_mveqa_batch_0352_r2_train-dpi200_aug_noaug_maxp40/"
            "train_part2/converted_sft/wrong_question_ids.txt"
        ),
    ...
    Lane(
        ...
        export_dir=Path(
            ...
            "veqa_batch_0350_r2_train_6508_additional_mveqa_batch_0352_r2_train_6508_additional-"
            "dpi200_aug_noaug_maxp40_jitter_seed0_pagedrop0.5_irrel0.3_seed0/"
            "train_part3/exported_conversations"
        ),
        wrong_ids_path=Path(
            "/home/ywxzml3j/ywxzml3juser40/insight_doc/outputs/"
            "insight_qwen_agent_zoom_factor2_default_sys_0426_resumable/"
            ...
            "veqa_batch_0350_r2_train_6508_additional_mveqa_batch_0352_r2_train_6508_additional-"
            "dpi200_aug_noaug_maxp40_jitter_seed0_pagedrop0.5_irrel0.3_seed0/"
            "train_part3/converted_sft/wrong_question_ids.txt"
        ),
...
def main() -> int:
    ...
    for lane in LANES:
        ...
        if not qids:
            raise ValueError(f"no answerable easy question_ids remain for {lane.name}")
        ...
        summary["lanes"].append(
            {
                ...
                "manifest_answerable_question_ids": len(answerable_qids),
                "exported_question_ids": len(exported_qids),
                "wrong_question_ids": len(wrong_qids),
                "answerable_easy_question_ids": len(qids),
                "rows": len(df),
            }
        )
