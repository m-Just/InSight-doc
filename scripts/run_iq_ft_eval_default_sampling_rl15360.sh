...
export WORK_DIR="${WORK_DIR:-$OUTPUT_ROOT/iq_ft_eval_default_sampling_rl15360}"
export MODEL_PATH="${MODEL_PATH:-/scratch/ywxzml3j/likaican/temp/insight_qwen_agent_full_sft_eval_resume48_pathimg_mp/sft_checkpoints/global_step_72/huggingface}"
export PROJECT_NAME="${PROJECT_NAME:-insight_doc}"
export EXP_NAME="${EXP_NAME:-iq_ft_eval_default_sampling_rl15360_r6}"
