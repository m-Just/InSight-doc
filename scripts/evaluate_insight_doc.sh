...
export REPO_ROOT
export MODEL_CONFIGS="${MODEL_CONFIGS:-standalone_eval/model_configs/release_ray_vllm.yaml}"
export AGENT_CONFIG="${AGENT_CONFIG:-standalone_eval/agent_configs/insight_qwen_agent_core_zoom_factor2_area3500_rescale025.yaml}"
...
exec "$REPO_ROOT/scripts/queue_standalone_full_eval_sweep.sh" "$@"
