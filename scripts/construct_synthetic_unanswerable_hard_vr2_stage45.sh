...
INPUT_ROOT="${INPUT_ROOT:-${VERL_ROOT}/artifacts/synthetic_unanswerable_pipeline/by_rescale_20260518/hard}"
RUN_TAG="${RUN_TAG:-retry_hard_by_rescale_20260518}"
EXP_NAME_BASE="${EXP_NAME_BASE:-synthetic_unanswerable_qwen3_region_loc_hard_retry_by_rescale}"
...
run_one() {
  ...
  echo "==> synthetic unanswerable hard rescale${rescale}"
...
echo "Done: synthetic unanswerable hard rescale 0.25 / 0.35 / 0.5"
