...
INPUT_ROOT="${INPUT_ROOT:-${VERL_ROOT}/artifacts/answerable_vr2_inputs/by_rescale_20260518/easy}"
RUN_TAG="${RUN_TAG:-retry_easy_by_rescale_20260518}"
EXP_NAME_BASE="${EXP_NAME_BASE:-answerable_qwen3_region_loc_easy_retry_by_rescale}"
...
run_one() {
  ...
  echo "==> answerable easy rescale${rescale}"
...
echo "Done: answerable easy rescale 0.25 / 0.35 / 0.5"
