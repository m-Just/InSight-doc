#!/usr/bin/env python3
"""Pack exported InSight-doc conversations into a portable notebook bundle.
...
PORTABLE_VIEWER_PY = r'''"""Standalone viewer for packed InSight-doc exported conversations."""
    ...
    cells = [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": "# Portable Exported Conversation Viewer\n\nThis notebook is generated by `pack_exported_conversation_viewer.py` and expects to run from the bundle directory.",
        },
        {
            "cell_type": "code",
...
jupyter lab visualize_exported_conversations_portable.ipynb
```
...
def main() -> None:
    ...
    write_text(output_dir / "portable_exported_conversation_viewer.py", PORTABLE_VIEWER_PY)
    write_notebook(output_dir / "visualize_exported_conversations_portable.ipynb")
