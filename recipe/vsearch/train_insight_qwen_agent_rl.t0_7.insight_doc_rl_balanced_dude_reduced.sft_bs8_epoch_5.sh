...
export MODEL_PATH='/scratch/ywxzml3j/likaican/temp/insight_qwen_agent_full_sft_all_convos_0426_batch_lr_sweep/insight_qwen_agent_full_sft_all_convos_0426_lr2e-6_cosine_minlr2e-7_len32768_bs8_full_clean_data_freeze_vt/sft_checkpoints/global_step_10530/huggingface'
...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_sft_bs8_epoch_5"
...
export TRAIN_FILES='[/scratch/ywxzml3j/likaican/data/insight_doc/insight_doc_rl_balanced_dude_reduced_merged_u25-insight_qwen_agent.parquet]'
