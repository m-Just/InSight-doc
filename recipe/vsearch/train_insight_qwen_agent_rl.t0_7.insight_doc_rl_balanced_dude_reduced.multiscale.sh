...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_data_multiscale"
...
export TRAIN_FILES='[/scratch/ywxzml3j/likaican/data/insight_doc/answerable_plus_synthetic_unanswerable_vr2_wrong_rl_20260519_uniform_rescale05_maxarea3500x3500_le11000_u25_with_initial_rescale-insight_qwen_agent.parquet]'  # this is only le11000 filtered data
