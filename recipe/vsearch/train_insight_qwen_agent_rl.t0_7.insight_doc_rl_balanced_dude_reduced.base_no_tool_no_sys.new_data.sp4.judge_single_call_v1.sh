...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_data_sp4_rl16k_prompt24k_weighted_refill_simple_source_judge_single_call_v1_base_no_tool_no_system"
# export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_base_no_tool_no_system_new_data"
...
export TRAIN_FILES='[/scratch/ywxzml3j/likaican/src/verl-qwen3-vl/notes/generated/rl_16k_prompt24k_r05_to_r035_simple_datasource_20260617/insight_doc_rl_16k_prompt24k_r05_to_r035_simple_datasource-insight_qwen_agent_no_tool_no_system.parquet]'
# export TRAIN_FILES='[/scratch/ywxzml3j/likaican/data/insight_doc/answerable_plus_synthetic_unanswerable_vr2_wrong_rl_20260519_per_sample_rescale_maxarea3500x3500_le11000_u25_with_initial_rescale_map_reduced_source_u20_arxiv_map_4of5_no_system-insight_qwen_agent.parquet]'  # this is only le11000 filtered data
export VAL_FILES='[/scratch/ywxzml3j/likaican/temp/arxiv_0307_sample_veqa_batch_0350_mveqa_batch_0352_maxp40-insight_qwen_agent_no_tool_no_system.test.parquet,/scratch/ywxzml3j/likaican/temp/eval_data_0502_parquets/dude200-insight_qwen_agent_no_tool_no_system.parquet,/scratch/ywxzml3j/likaican/temp/eval_data_0502_parquets/mmlongbench200-insight_qwen_agent_no_tool_no_system.parquet,/scratch/ywxzml3j/likaican/temp/eval_data_0502_parquets/o3bench0502-insight_qwen_agent_no_tool_no_system.parquet]'
...
run_experiment \
    ...
    actor_rollout_ref.rollout.multi_turn.qwen_tool_list=[] \
