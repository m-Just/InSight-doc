...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_sft_2ep_new_data_sp4_rl16k_prompt24k_weighted_refill_simple_source_unans014_judge_single_call_v1"
...
# recipe/vsearch/config/insight_doc_rl_category_answerability_sampling_weights_prompt24k_simple_source_custom_unans014_20260627.yaml.
...
# Category marginals are unchanged from the 20260617 custom plan:
#   arxiv_mveqa:0.185, arxiv_veqa:0.185, docvqa:0.100, dude:0.225,
#   info:0.040, map_metro:0.150, map_travel:0.040, poster:0.075.
# This variant reduces total unanswerable sampling mass to 14% while preserving
# category marginals and each category's relative unanswerable share.
#
# category            answerable       unanswerable               total
# ━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━
# arxiv_mveqa    16.368%             2.132%            18.500%
# arxiv_veqa     16.368%             2.132%            18.500%
# docvqa          8.848%             1.152%            10.000%
# dude           19.907%             2.593%            22.500%
# info            3.078%             0.922%             4.000%
# map_metro      12.695%             2.305%            15.000%
# map_travel      3.539%             0.461%             4.000%
# poster          5.195%             2.305%             7.500%
# total          86.000%            14.000%           100.000%
#
...
run_experiment \
    ...
    data.batch_sampler.weights_file=/scratch/ywxzml3j/likaican/src/verl-qwen3-vl/recipe/vsearch/config/insight_doc_rl_category_answerability_sampling_weights_prompt24k_simple_source_custom_unans014_20260627.yaml \
