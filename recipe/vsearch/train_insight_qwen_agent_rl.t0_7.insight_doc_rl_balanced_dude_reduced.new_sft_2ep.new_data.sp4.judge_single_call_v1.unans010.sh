...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_sft_2ep_new_data_sp4_rl16k_prompt24k_weighted_refill_simple_source_unans010_judge_single_call_v1"
...
# recipe/vsearch/config/insight_doc_rl_category_answerability_sampling_weights_prompt24k_simple_source_custom_unans010_20260627.yaml.
...
# This variant reduces total unanswerable sampling mass to 10% while preserving
# category marginals and each category's relative unanswerable share.
#
# category            answerable       unanswerable               total
# ━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━  ━━━━━━━━━━━━━━━━━━
# arxiv_mveqa    16.977%             1.523%            18.500%
# arxiv_veqa     16.977%             1.523%            18.500%
# docvqa          9.177%             0.823%            10.000%
# dude           20.648%             1.852%            22.500%
# info            3.342%             0.658%             4.000%
# map_metro      13.354%             1.646%            15.000%
# map_travel      3.671%             0.329%             4.000%
# poster          5.854%             1.646%             7.500%
...
run_experiment \
    ...
    data.batch_sampler.weights_file=/scratch/ywxzml3j/likaican/src/verl-qwen3-vl/recipe/vsearch/config/insight_doc_rl_category_answerability_sampling_weights_prompt24k_simple_source_custom_unans010_20260627.yaml \
