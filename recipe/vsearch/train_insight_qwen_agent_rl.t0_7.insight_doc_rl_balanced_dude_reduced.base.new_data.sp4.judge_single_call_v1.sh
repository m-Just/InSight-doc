...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_data_sp4_rl16k_prompt24k_weighted_refill_simple_source_judge_single_call_v1_base"
...
run_experiment \
    ...
    +data.batch_sampler.skew_tail_p=0.005 \
    +data.batch_sampler.skew_grouping=family_prefix \
    '+data.batch_sampler.skew_extra_groups.page_heavy=[arxiv,docvqa]' \
    +data.batch_sampler.max_resample_attempts=20 \
