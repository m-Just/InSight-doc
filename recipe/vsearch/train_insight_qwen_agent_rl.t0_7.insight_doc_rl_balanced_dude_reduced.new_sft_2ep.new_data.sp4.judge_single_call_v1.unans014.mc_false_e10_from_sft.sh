...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_sft_2ep_new_data_sp4_rl16k_prompt24k_weighted_refill_simple_source_unans014_mc_false_e10_judge_single_call_v1_from_sft"
...
# Step-0 variant: start from MODEL_PATH SFT weights, not an RL checkpoint.
# Avoid accidentally inheriting RESUME_FROM_STEP=800 from a forked-run shell.
...
# recipe/vsearch/config/insight_doc_rl_category_answerability_sampling_weights_prompt24k_simple_source_custom_unans014_mc_false_e10_20260705.yaml.
...
# This variant keeps total unanswerable sampling mass at 14%, assigns 10% mass
# to filtered MC false-E rows, and leaves the remaining 76% on original
...
run_experiment \
    ...
    data.batch_sampler.weights_file=/scratch/ywxzml3j/likaican/src/verl-qwen3-vl/recipe/vsearch/config/insight_doc_rl_category_answerability_sampling_weights_prompt24k_simple_source_custom_unans014_mc_false_e10_20260705.yaml \
