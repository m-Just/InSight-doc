...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_new_sft_2ep_new_data_sp4_rl16k_prompt24k_weighted_refill_simple_source_unans014_mc_false_e05_judge_legacy_from500"
...
# at global_step_500. Override RESUME_FROM_STEP only if intentionally resuming
# from another checkpoint in this fork.
export RESUME_FROM_STEP="${RESUME_FROM_STEP:-500}"
