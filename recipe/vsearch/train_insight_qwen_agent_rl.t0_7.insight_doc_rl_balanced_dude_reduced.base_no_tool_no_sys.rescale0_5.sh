...
export EXP_NAME="insight_doc_rl_balanced_dude_reduced_u25_qwen3_insight_qwen_agent_rl_t0_7_def_sparams_base_no_tool_no_system_new_data_rescale05"
...
export TRAIN_FILES='[/scratch/ywxzml3j/likaican/data/insight_doc/answerable_plus_synthetic_unanswerable_vr2_wrong_rl_20260519_uniform_rescale05_maxarea3500x3500_le11000_no_initial_rescale_u25_no_system-insight_qwen_agent.parquet]'  # this is only le11000 filtered data
...
MAX_IMG_TOKENS_TRAIN=12K  # roughly 3500 * 3500 pixels per image for qwen3-vl
MAX_IMG_TOKENS_VAL=12K
...
run_experiment \
    ...
    actor_rollout_ref.rollout.agent.agent_loop_config_path="recipe/vsearch/config/agent_insight_qwen_agent_zoom_factor2_area3500_rescale05.yaml" \
